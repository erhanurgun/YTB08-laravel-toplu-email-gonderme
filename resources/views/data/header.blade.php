        ...
        <nav class="topbar-nav">
            <ul class="metismenu" id="menu">
                ...
                <li>
                    ...
                    <ul>
                        <li><a href="{{ route('customers') }}"><i class="bx bx-right-arrow-alt"></i>Müşteri Listesi</a></li>
                        <li><a href="{{ route('add-customer') }}"><i class="bx bx-right-arrow-alt"></i>Yeni Müşteri</a></li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        <li><a href="{{ route('compose-email') }}"><i class="bx bx-right-arrow-alt"></i>Toplu Mail Oluşturma</a></li>
                        <li><a href="#"><i class="bx bx-right-arrow-alt"></i>Mail Takibi</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript:;">
                        <div class="parent-icon"><i class="bx bx-lock-open"></i></div>
